    ...
    <>
      ...
      <nav className=" bg-white sm:py-4 px-4 py-2 md:shadow-md shadow-xl uppercase font-[900] fixed top-0 left-0  w-full z-20">
        <div className="flex justify-between md:justify-around items-center gap-10">
          ...
          <div>
            <h1 className="sm:text-xl text-lg font-[900] sm:text-gray-800 text-black">
              Shop
            </h1>
          </div>
          ...
          <div className="flex items-center md:hidden gap-5 text-lg sm:text-xl sm:text-gray-800 text-black">
            <button>
              <BsCart2 />
            </button>
            <button>
